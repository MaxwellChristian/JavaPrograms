...
3. Input the number of students and then read name and score for that each student. After all inputs display the name of the student with highest score
        ...
        do {
            ...
            switch (userChoice) {
                case 1:
                    ...
                    System.out.println(numnber + " : " + Integer.toBinaryString(numnber));
                ...
                case 5:
                    ...
                    if (sinNumber.length() != MAX_DIGITS_IN_SIN_NUMBER) {
                        System.out.println("SIN number must be of 9 digits");
                    } else {
