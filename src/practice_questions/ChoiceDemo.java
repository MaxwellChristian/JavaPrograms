...
3. Input the number of students and then read name and score for that each student. After all inputs display the name of the student with the highest score
